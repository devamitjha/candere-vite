...
const CompleteLooks = () => {
  return (
    <div className="w-full bg-gray-100 pt-1 mt-25 pb-8 px-4">
        <MainTitle
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4 gap-4">
        ...
        {CompleteLookData.map((item, index) => (
          <div className="group rounded-lg bg-white p-6" key={index}>
            ...
            <div className="flex flex-col lg:flex-row justify-between lg:items-stretch gap-8">
              ...
              <div className="flex-1 flex flex-col justify-between h-full relative overflow-hidden group">
                ...
                <div className="hidden lg:block text-xl font-bold">{item.price.formatted}</div>
                  <div className="w-full flex items-center justify-between mt-4 lg:absolute left-0 -bottom-25 group-hover:bottom-0 transition-bottom duration-300 bg-white">
