    ...
    <>
        <div className="px-5 flex justify-between w-full gap-4">
            <div className="flex justify-start w-[48%] lg:w-[20%]">  
                <div className="w-14 h-14 flex justify-center items-center mr-2 lg:hidden"><AlignLeft /></div>  
                <Link className="w-13 h-13 flex justify-center items-center overflow-hidden p-2 lg:p-0" to="/">
            ...
            <div className="hidden lg:flex grow justify-center items-center">
                <div className="flex w-full items-center relative h-14 overflow-hidden border border-gray-300 rounded-lg">
                    <Input type="search" placeholder="Search jewellery" className="border-0 w-full h-full hover:outline-0 pr-21" />
            ...
            <Link className="w-14 h-14 flex justify-center items-center relative">
                <Heart size={24} />                
            ...
            <Link className="w-14 h-14 flex justify-center items-center relative" to="/checkout/cart">
                <ShoppingCart size={24} />
                {count > 0 && <Badge  className="h-5 min-w-5 rounded-full px-1 font-mono tabular-nums absolute right-0 top-0" variant="destructive">{count}</Badge>}
            </Link>
            </div>
            </div>
            <div className="flex lg:hidden grow justify-center items-center px-5 mt-3">
                <div className="flex w-full items-center relative h-14 overflow-hidden border border-gray-300 rounded-lg">
                    <Input type="search" placeholder="Search jewellery" className="border-0 w-full h-full hover:outline-0 pr-21" />
                    <Button type="submit" className="primary-gradient absolute right-0 top-0 w-20 h-14 rounded-l-none">
                        <Search size={20} className="text-white" />
